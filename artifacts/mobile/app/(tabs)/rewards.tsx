...
const styles = StyleSheet.create({
  ...
  balanceAmount: { fontSize: 30, fontFamily: 'Inter_700Bold', letterSpacing: -1 },
  ...
  tierAmount: { fontSize: 17, fontFamily: 'Inter_700Bold', letterSpacing: -0.3 },
  tierLabel: { fontSize: 11, fontFamily: 'Inter_500Medium' },
  methodRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 },
  methodText: { fontSize: 11, fontFamily: 'Inter_400Regular', flexShrink: 1 },
